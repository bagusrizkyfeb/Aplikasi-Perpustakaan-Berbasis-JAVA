 ...
 * @author Bagus Rizky
 */
public class dataanggota2 extends javax.swing.JFrame {
    ...
    private void jTable3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable3MouseClicked
        ...
        String stat = "0";
        if(stat.equals(jTable3.getValueAt(baris, 9))){
            JOptionPane.showMessageDialog(null, "Sedang dalam masa peminjaman Dan Kuota Peminjaman Buku Telah Habis  !","Kesalahan", JOptionPane.ERROR_MESSAGE);  
        }else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dataanggota2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new dataanggota2().setVisible(true);
            }
        });
    }
